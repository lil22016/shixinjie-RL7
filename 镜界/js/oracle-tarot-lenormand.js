...
function configure(){
  ...
  if(sel){
    ...
    if(sel.value!=='lenormand') sel.value='tarot';
  }
  const mode=document.getElementById('divine-draw-mode'); if(mode){mode.value='deck'; const g=mode.closest('.config-group'); if(g) g.style.display='none';}
